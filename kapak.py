...
from kpk_mods.enc_n_dec import aesEncryptor, writeMeta, readMeta, encFile, decFile
		...
		if os.path.isdir(p):
			...
			if mode == ENCRYPT_MODE:
				...
				for f in fList:
					...
					encFile(encryptor, f, total_size)
				...
				for f in fList:
					...
					decFile(decryptor, f, total_size, f_out_ext)
			...
			if mode == ENCRYPT_MODE:
				...
				decFile(decryptor, p, p_size, f_out_ext)
